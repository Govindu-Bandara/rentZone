...
export default function ActionConfirmModal({
  ...
  return (
    <div
      ...
      style={{ position: 'fixed', inset: 0, background: 'rgba(2,6,23,0.55)', display: 'grid', placeItems: 'center', zIndex: 1300, padding: 16 }}
    >
      <div style={{ background: '#fff', borderRadius: 16, width: 'min(520px,96vw)', boxShadow: '0 24px 60px rgba(0,0,0,0.25)', overflow: 'hidden' }}>
