...
export const handler = async (event) => {
  ...
  try {
    ...
    if (location !== undefined) {
      ...
      // Extract city from title if title is being updated
      const titleExtractedCity = title ? extractCityFromTitle(title) : null;
    ...
    const significantFields = ['title', 'description', 'price', 'location', 'propertyDetails', 'images', 'mainImage'];
